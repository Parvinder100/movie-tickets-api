...
public class TicketFactoryTest {
    ...
    public void testCreateTicket_whenValidSeniorCustomer_returnValidSeniorTicket() {
        ...
        Assert.assertEquals(Ticket.builder().ticketType(TicketType.Senior).totalCost(17.5f).quantity(1).build(), ticket);
    }
    ...
    public void testCreateTicket_whenValidAdultCustomerWith64Age_returnValidAdultTicket() {
        ...
        Assert.assertEquals(Ticket.builder().ticketType(TicketType.Adult).totalCost(25).quantity(1).build(), ticket);
    }
    ...
    public void testCreateTicket_whenValidTeenCustomerWith17Age_returnValidTeenTicket() {
        ...
        Assert.assertEquals(Ticket.builder().ticketType(TicketType.Teen).totalCost(12).quantity(1).build(), ticket);
    }
    ...
    public void testCreateTicket_whenValidChildCustomer_returnValidChildrenTicket() {
        ...
        Assert.assertEquals(Ticket.builder().ticketType(TicketType.Children).totalCost(5).quantity(1).build(), ticket);
    }
}